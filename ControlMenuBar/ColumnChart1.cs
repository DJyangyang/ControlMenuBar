...
{
    public partial class ColumnChart1 : Form
    {
        ...
        public ColumnChart1(DataTable dt, string xFieldName, string yFieldName, string zFieldaName, string legendText, string legendtext)
        {
            InitializeComponent();
            this._dt = dt;
